...
\title{Cálculo de la Temperatura de Saturación} % The article title

\author{
	\authorstyle{Santiago Sanz Wuhl} % Authors
}
...
\lettrineabstract{La temperatura de saturación, análoga a la presión de saturación de una sustancia es la temperatura para la cual el líquido se encuentra en equilibrio dinámico con el gas. Como es bien sabido, la presión atmosférica es variable y dependiente de la altura, es por esto que la temperatura de ebullición(de saturación) de un líquido variará con la altura. Estimando la temperatura de saturación, se podrá inferir la cantidad de energía necesaria para hervir cierta sustancia. }
